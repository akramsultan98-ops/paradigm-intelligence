...
3. NEVER STATE A PREDICTED EVENT AS CONFIRMED. Three separate fields keep \
these apart, and you must fill all three for any opportunity:
   - `fact`: ONLY what the document states, in its own terms. No reasoning, no \
     speculation. If the document states little, say little.
   - `inference`: what follows from that fact. Reasoned, not stated. Hedge it \
     ("suggests", "would typically require").
